                        ...
                        <tbody class="text-center">
                            ...
                            <tr>
                                ...
                                <td class="d-block d-md-table-cell favourites__img">
                                    <img src="{{asset('assets')}}/images/{{ $favorite->product->image }}" alt="" />
                                </td>
                                <td class="d-block d-md-table-cell">
                                    <a href=""> {{ $favorite->product->name }} </a>
                                </td>
                                <td class="d-block d-md-table-cell">
                                    <span class="product__price product__price--old">{{ $favorite->product->price }} جنية</span>
                                    <span class="product__price">{{ $favorite->product->price_after_discount }} جنية</span>
                                </td>
